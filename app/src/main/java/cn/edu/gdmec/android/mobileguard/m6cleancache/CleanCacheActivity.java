...
public class CleanCacheActivity extends AppCompatActivity implements View.OnClickListener {
    public static final int CLEANNING = 100;
    public static final int CLEAN_FINISH = 10;
    ...
    private void cleanAll() {
        ...
        for (Method method:methods){
            if ("freeStorageAndNotify".equals(method.getName())){
                try {
                    method.invoke(pm,"",Integer.MAX_VALUE,new CleanCacheObserver());
                } catch (Exception e) {
                    e.printStackTrace();
                }
                return;
    ...
    private void initView() {
        ...
        ((TextView)findViewById(R.id.tv_title)).setText("緩存清理");
